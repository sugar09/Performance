...
import { BASE_URL, MANIFEST_PATH_MIXED } from "../config/enviroment.js";

const REQ_TIMEOUT = "180s";

const _allEntries = new SharedArray("mixed", function () {
  const manifest = JSON.parse(open(MANIFEST_PATH_MIXED));
